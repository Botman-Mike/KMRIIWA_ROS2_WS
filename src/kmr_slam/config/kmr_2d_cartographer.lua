...
options = {
  ...
  map_frame = "map",
  tracking_frame = "base_link",         -- modified: was "base_footprint"
  published_frame = "base_link",         -- modified: was "base_footprint"
  odom_frame = "odom",
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 90  -- modified: changed from 350 for Humble defaults
POSE_GRAPH = {
  constraint_builder = {
    sampling_ratio = 0.3,
