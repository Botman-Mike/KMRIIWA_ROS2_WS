...
class Buffer(tf2.BufferCore, tf2_ros.BufferInterface):
    ...
    def lookup_transform(self, target_frame, source_frame, time, timeout=Duration(seconds=0.0)):
        """
    ...
    def lookup_transform_full(self, target_frame, target_time, source_frame, source_time, fixed_frame, timeout=Duration(seconds=0.0)):
        """
    ...
    def can_transform(self, target_frame, source_frame, time, timeout=Duration(seconds=0.0), return_debug_tuple=False):
        """
    ...
    def can_transform_full(self, target_frame, target_time, source_frame, source_time, fixed_frame, timeout=Duration(seconds=0.0),
