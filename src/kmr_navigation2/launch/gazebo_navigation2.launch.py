...
def generate_launch_description():
    use_sim_time = LaunchConfiguration('use_sim_time', default='true')  # Updated default
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(nav2_launch_file_dir, 'bringup_launch.py')),  # Updated source path
            launch_arguments={
                'map': map_dir,
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(state_publisher_launch_file_dir, 'state_publisher.launch.py')),  # Updated source path
        ),
